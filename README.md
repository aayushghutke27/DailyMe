...
DailyMe uses the Android Credential Manager API for Google Sign In — a native bottom sheet, one tap, no password, no OTP. The app integrates **Verified Email**, the latest addition to the Credential Manager API.
...
**What Verified Email unlocks for onboarding and beyond:**
...
| Screen | Description |
|---|---|
| **Onboarding** | Feature highlights, Google Sign In + Verified Email via Credential Manager |
...
│   │   │   └── MealEntity.kt
│   │   └── database
│   │       └── NutriSenseDatabase.kt
│   │
│   ├── repository
│   │   ├── GeminiRepository.kt
│   │   ├── GeminiRepositoryImpl.kt
│   │   ├── MealsRepository.kt
│   │   ├── MealsRepositoryImpl.kt
│   │   ├── AuthRepository.kt
│   │   └── AuthRepositoryImpl.kt
│   │
│   └── datastore
│       ├── UserPreferenceDatastore.kt
│       └── UserPreferenceKey.kt
│
├── domain
│   └── model
│       ├── MealAnalysis.kt
│       └── MacroWeeklySummary.kt
│
├── di
│   ├── AppModule.kt
│   ├── DatabaseModule.kt
...
│   │   │   ├── MealsDetailUiState.kt
│   │   │   └── Components
│   │   │       ├── HealthyScoreCard.kt
│   │   │       ├── MealsPhotoCard.kt
│   │   │       ├── MacronutrientCard.kt
│   │   │       ├── LoadingCard.kt
│   │   │       └── ErrorCard.kt
│   │   ├── SelectMethodScreen
│   │   │   ├── SelectMethodScreen.kt
...
<p align="left">
  ...
  &nbsp;
  <a href="mailto:aayushghutke27@gmail.com">
    <img src="https://img.shields.io/badge/Email-aayushghutke27@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
</p>
